...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const result = await db.runTransaction(async (tx) => {
            ...
            const openStatuses = ["scheduled_requested"];
            const alreadyTaken =
                (r.driver_id && r.driver_id !== driverId) || !openStatuses.includes(r.status);
            ...
            tx.update(rideRef, {
                ...
                scheduled_accepted_at: FieldValue.serverTimestamp(),
            });
        ...
        console.error("accept-scheduled-ride error:", e);
        return res.status(500).json({ success: false, error: "Failed to accept scheduled ride" });
    }
};
